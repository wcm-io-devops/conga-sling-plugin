...
class OsgiCfgJsonFileHeaderTest {

  private FileHeaderPlugin underTest;

  @BeforeEach
  void setUp() {
    underTest = new PluginManagerImpl().get(OsgiCfgJsonFileHeader.NAME, FileHeaderPlugin.class);
  }

  @Test
  void testApply() throws Exception {
    File file = new File("target/generation-test/fileHeader.cfg.json");
    FileUtils.copyFile(new File(getClass().getResource("/configSample.cfg.json").toURI()), file);
